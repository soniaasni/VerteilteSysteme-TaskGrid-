...
\begin{itemize}
  \item \textbf{Issue \#39 (Skalierungstest)}: Kann erst durchgeführt
        werden wenn der Namensdienst als vollständiger gRPC-Server
        implementiert ist (Teammitglied Xplosy) und die Worker-Task-Handler
        fertiggestellt sind (Elena7x).
  \item \textbf{End-to-End-Test im Container}: Ist nach Fertigstellung
        der anderen Komponenten geplant.
\end{itemize}
...
\texttt{WORKER\_ID}-Generierungsschema vollständig vorbereitet.
