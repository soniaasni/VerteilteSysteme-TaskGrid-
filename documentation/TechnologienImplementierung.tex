...
\subsection{Containerisierung (Phase 3, Issues \#34--\#39)}
...
\textbf{Keine Worker-Adressen}: Gemäß Aufgabenanforderung §4.2 enthält das
...
mit Dispatcher), \texttt{src/worker/task\_handlers/} und
...
\textbf{entrypoint.sh -- ENV-VAR-Mapping und WORKER\_ID-Generierung}:
