...
wurden alle Dispatcher-Proto-Definitionen auf Konventionen abgestimmt:

\begin{table}[H]
\centering
\begin{tabular}{lll}
\toprule
\textbf{Aspect} & \textbf{Worker-Konvention} & \textbf{Dispatcher-intern} \\
\midrule
...
\bottomrule
\end{tabular}
\caption{Proto-Kompatibilität Dispatcher/Worker}
\end{table}
