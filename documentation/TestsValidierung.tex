...
Die Implementierung des Dispatchers (Phase 2, Issues \#13--\#21) wurde
...
Begründung: Da gRPC die einzige externe Schnittstelle ist, geben
...
\subsubsection{PostTask (Issue \#13)}
\begin{itemize}
...
\subsubsection{GetResult (Issue \#17)}
\begin{itemize}
...
\subsubsection{Timeout + Retry (Issue \#18)}
\begin{itemize}
...
\subsubsection{Nebenläufigkeit (Issue \#21)}
\begin{itemize}
...
Die Docker-Konfiguration (Issues \#34--\#38) wurde durch manuelle
...
Ein vollständiger End-to-End-Test des containerisierten Systems
(Issue \#39 -- Skalierungstest) steht aus, da die Namensdienst-
